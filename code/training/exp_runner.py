...
from training.train_material_with_monoalbedo import MaterialTrainRunner
...
if __name__ == '__main__':
    ...
    parser.add_argument('--normal_path', type=str, default='')
    ...
    # idr pretrained ckpt
    parser.add_argument('--geo_path', type=str, default='', help='idr pretrained ckp')
    ...
    trainrunner = runder_dict[opt.trainstage](conf=opt.conf,
                                            ...
                                            normal_path=opt.normal_path,
                                            albedo_path=opt.albedo_path,
